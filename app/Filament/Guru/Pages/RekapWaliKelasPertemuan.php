...
class RekapWaliKelasPertemuan extends Page implements Tables\Contracts\HasTable
{
    ...
    protected static ?string $slug = 'rekap-wali-kelas-pertemuan/{jadwal}';
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('kembali')
                ->label('Kembali')
                ->url(RekapWaliKelasDetail::getUrl([
        ...
        return $table
            ...
            ->recordActions([
                Action::make('lihatSiswa')
                    ->label('Lihat Siswa')
                    ->icon('heroicon-o-eye')
                    ->url(fn (PresensiSesi $record): string => RekapWaliKelasSiswa::getUrl([
                        'record' => $record->id,
                    ])),
            ])
            ->toolbarActions([]);
